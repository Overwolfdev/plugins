...
# @overwolfdevdevdev/plugin-logger
...
[![npm bundle size](https://img.shields.io/bundlephobia/min/@overwolfdevdevdev/plugin-logger?logo=webpack&style=flat-square)](https://bundlephobia.com/result?p=@overwolfdevdevdev/plugin-logger)
[![npm](https://img.shields.io/npm/v/@overwolfdevdevdev/plugin-logger?color=crimson&logo=npm&style=flat-square)](https://www.npmjs.com/package/@overwolfdevdevdev/plugin-logger)
...
`@overwolfdevdevdev/plugin-logger` depends on the following packages. Be sure to install these along with this package!
...
```sh
npm install @overwolfdevdevdev/plugin-logger @sapphire/framework
```
...
import '@overwolfdevdevdev/plugin-logger/register';
```
